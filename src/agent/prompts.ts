...
- When consequential execution is needed, call \`execution_handoff\`. Its UI lets the user directly choose Switch to AGENT or Stay in ASK. Never synthesize, infer, or replay that choice, and never silently elevate authority.
`,
  AGENT: `
## Mode: AGENT
