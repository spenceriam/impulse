...
|-----------|-------|----------|
| COMPACT_TRIGGER_THRESHOLD | 0.5 (50%) | `src/agent/loop.ts:67` |
| COMPACT_RESIDUAL_THRESHOLD | 0.3 (30%) | `src/agent/loop.ts:68` |
| Safety margin multiplier | 1.15x | `src/agent/loop.ts` (hard estimate ceiling) |
