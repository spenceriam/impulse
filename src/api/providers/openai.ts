 ...
 * 
 * Provider implementation for OpenAI API (GPT models)
 */
...
import { executeWithRetry } from "./openai-compatible.js";
...
export class OpenAIProvider implements AIProvider {
  ...
  private async getClient(): Promise<OpenAI> {
    ...
    if (!this.config.apiKey) {
      throw new ProviderAuthError("API key not configured for OpenAI provider");
    }
