...
- title (required): Specific description of the conversation, 2-10 words, max 80 characters
...
- **Word band:** 2-10 words. One-word labels and sentence-length titles are rejected.
