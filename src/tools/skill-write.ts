...
The skill becomes available immediately inside the /skills submenu. Skill frontmatter
never adds a top-level slash command, so large skill collections stay discoverable.
